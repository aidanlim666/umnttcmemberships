export const en = {
  ...
  'announce.4':
      'Members can enter their personal code under for promo code to register for leagues free',
  ...
  'checkout.securedBy':
      'Payments are processed by PayPal and Stripe. The club never sees your card details.',
  ...
  'success.sub':
      'Your purchase is confirmed and your name is on the club roster.',
